...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Iots address\n"
            "  payee          - Print the masternode payout Iots address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Iots address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "iots",               "masternode",             &masternode,             true,  {} },
    { "iots",               "masternodelist",         &masternodelist,         true,  {} },
    { "iots",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "iots",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
