# Linearize
Construct a linear, no-fork, best version of the Iots blockchain. The scripts
...
JSON-RPC server. Running `iotsd` or `iots-qt -server` will be sufficient.
...
* `input`: iotsd blocks/ directory containing blkNNNNN.dat
