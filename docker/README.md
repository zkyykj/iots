...
official/supported Docker Images found at https://hub.docker.com/r/iotspay/iotsd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/iotspay/iotsd-develop/ when changing the above text**