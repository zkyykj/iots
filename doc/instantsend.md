...
This mechanism has been integrated into Bitcore-Node-Iots which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/iotspay/insight-api-iots#web-socket-api](https://github.com/iotspay/insight-api-iots#web-socket-api)
* API: [https://github.com/iotspay/insight-api-iots#instantsend-transactions](https://github.com/iotspay/insight-api-iots#instantsend-transactions)
