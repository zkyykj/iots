...
* iots.conf: contains configuration settings for iotsd or iots-qt
* iotsd.pid: stores the process id of iotsd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by iotsd or iots-qt
