...
* Update translations, see [translation_process.md](https://github.com/iotspay/iots/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/iotspay/iots/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/iotspay/iots.git
...
- Detached signatures will then be committed to the [iots-detached-sigs](https://github.com/iotspay/iots-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the iots.org server*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the iots.org server

- Update iots.org

- Announce the release:

  - Release on Iots forum: https://www.iots.org/forum/topic/official-announcements.54/

  - Optionally Discord, twitter, reddit /r/Iotspay, ... but this will usually sort out itself

  - Notify flare so that he can start building [the PPAs](https://launchpad.net/~iots.org/+archive/ubuntu/iots)

  - Archive release notes for the new version to `doc/release-notes/` (branch `master` and branch of the release)

  - Create a [new GitHub release](https://github.com/iotspay/iots/releases/new) with a link to the archived release notes.
